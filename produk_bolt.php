...
<nav class="navbar navbar-expand-lg navbar-dark custom-navbar fixed-top">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="dashboard.php#produk">Produk</a>
        </li>
        <li class="nav-item">
...
<div class="logo-section">
  ...
  <p><strong>BOLT - Best Care For Your Pets</strong><br>
  BOLT adalah makanan kucing berkualitas tinggi dengan berbagai pilihan varian. Mengandung nutrisi penting yang cocok untuk semua usia dan ras kucing.</p>
</div>

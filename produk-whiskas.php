...
<?php 
    ...
    <!-- ISI UTAMA -->
    <div class="content">
    <a href="produk_hills.php"><div class="back-arrow">&larr;</div></a>
    <a href="produk_bolt.php"><div class="next-arrow">&rarr;</div></a>
</div>

        <div class="logo-section">
            <img src="whiskas/logo_whiskas.png" alt="BOLT">
            <p><strong>Whiskas – Lezat dan Bergizi untuk Setiap Usia Kucing!</strong><br>Whiskas adalah merek makanan kucing yang dikenal dengan rasa lezat dan nutrisi seimbang untuk mendukung kesehatan kucing di setiap tahap kehidupan.</p>
        </div>
